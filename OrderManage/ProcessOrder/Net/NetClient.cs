...
namespace ProcessOrder.Net
{
    public class NetClient
    {
        ...
        public void Start()
        {
            try
            {
                ...
                ThreadPool.QueueUserWorkItem(new WaitCallback(Poll));
            }
            catch (Exception ex)
            {
   ...
   "异常详细信息" + ex.StackTrace + "\r\n");
        ...
        /// <returns></returns>
        public object SendObj(NetCommand ncmd, int timeout)
        {
            ...
            while (true)
            {
                ...
                {
                    if (Global.netData[ncmd.gid] != null)
                    {
                        object obj = Global.netData[ncmd.gid];
        ...
        /// <param name="ncmd"></param>
        /// <returns></returns>
        public object SendObj(NetCommand ncmd)
        {
            return SendObj(ncmd, 20);
        }
